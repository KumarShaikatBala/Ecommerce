        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                ...
                <div class="box-content">
                    {!! Form::open(['route' =>'store-brand','method' =>'post','class'=>'form-horizontal','enctype'=>'multipart/form-data'])!!}
                    {{ csrf_field() }}
                    <fieldset>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor" id="textarea2" rows="3" name="brand_details"></textarea>
                            </div>
                        </div>
